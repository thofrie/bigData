...
\begin{figure}[ht]
	\centering
  \includegraphics[width=0.5\textwidth]{img/distributionTest.png}
	\caption{Verteilung der Klassenlabel}
	\label{fig1}
\end{figure}
\end{frame}
...
\frametitle{Confusionmatrix Naiver Run (Decision Tree)}
\begin{figure}[ht]
	\centering
...
%------------------------------------------------
\begin{frame}
\frametitle{Confusionmatrix nach Oversampling (Decision Tree)}
\begin{footnotesize}
\begin{itemize}
